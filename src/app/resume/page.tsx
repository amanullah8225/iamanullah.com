...
export const metadata: Metadata = {
	...
	description:
		"The same resume, presented in several layouts — pick whichever fits where you're sending it.",
};
	...
	return (
		<Container>
			...
			<p className="mt-4 max-w-2xl">
				Every format below is generated from the same resume data, just laid out
				differently. Pick whichever reads best for where it&apos;s going.
			</p>
